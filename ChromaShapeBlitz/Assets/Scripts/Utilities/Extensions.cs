...
public static class Extensions
{
    ...
    public static string ToColorName(this BlockColors blockColors)
    {
        switch (blockColors)
        {
            case BlockColors.Blue:      return "Blue";
            case BlockColors.Green:     return "Green";
            case BlockColors.Magenta:   return "Magenta";
    ...
    public static Color ToUnityColor(this BlockColors blockColors)
    {
        switch(blockColors)
        {
            case BlockColors.Blue:      return Constants.ColorSwatches.BLUE;
            case BlockColors.Green:     return Constants.ColorSwatches.GREEN;
            case BlockColors.Magenta:   return Constants.ColorSwatches.MAGENTA;
