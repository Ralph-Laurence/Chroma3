...
public class BuyBackgroundPrompt : MonoBehaviour
{
    ...
    private BackgroundItemData itemData;
    private BackgroundShopItemCard eventSender;
    ...
    public void SetEventSender(BackgroundShopItemCard sender)
    {
        eventSender = sender;
    ...
    public void Show()
    {
        ...
        promptMessage.text = $"Do you want to buy this background for {cost} ?";
    ...
    public void Ev_Buy()
    {
        ...
        BackgroundPurchaseNotifier.NotifyObserver(eventSender);
    }
