...
public class CustomizationsHelper : MonoBehaviour
{
    ...
    public Dictionary<ColorSwatches, int> EquippedSkinIds { get; private set; }
    ...
    private IEnumerator PostInitialize()
    {
        ...
        EquippedSkinIds = new Dictionary<ColorSwatches, int>
        {
            { ColorSwatches.Blue,     deserializedData.EquippedSkinId.Blue    },
            { ColorSwatches.Green,    deserializedData.EquippedSkinId.Green   },
            { ColorSwatches.Orange,   deserializedData.EquippedSkinId.Orange  },
            { ColorSwatches.Purple,   deserializedData.EquippedSkinId.Purple  },
            { ColorSwatches.Magenta,  deserializedData.EquippedSkinId.Magenta },
            { ColorSwatches.Yellow,   deserializedData.EquippedSkinId.Yellow  },
        };
    }
    ...
    /// <returns>Coroutine</returns>
    public IEnumerator TakeSkinOwnership(int skinId, ColorSwatches colorGroup)
    {
    ...
    /// <param name="colorGroup">The color category where the skin belongs</param>
    /// <returns>Coroutine</returns>
    public IEnumerator EquipSkin(int skinId, ColorSwatches colorGroup)
    {
        // Update the On-Disk equipped skins
        var equipActions = new Dictionary<ColorSwatches, Action<int>>
        {
            { ColorSwatches.Blue    , (id) => deserializedData.EquippedSkinId.Blue    = id  },
            { ColorSwatches.Green   , (id) => deserializedData.EquippedSkinId.Green   = id  },
            { ColorSwatches.Orange  , (id) => deserializedData.EquippedSkinId.Orange  = id  },
            { ColorSwatches.Purple  , (id) => deserializedData.EquippedSkinId.Purple  = id  },
            { ColorSwatches.Magenta , (id) => deserializedData.EquippedSkinId.Magenta = id  },
            { ColorSwatches.Yellow  , (id) => deserializedData.EquippedSkinId.Yellow  = id  },
        };
    ...
    public bool FillBlockWithSkin(Material blockMaterial, ColorSwatches colorGroup)
    {
        ...
        if (colorGroup == ColorSwatches.None || DefaultSkinIds.Contains(skinId))
            return false;
